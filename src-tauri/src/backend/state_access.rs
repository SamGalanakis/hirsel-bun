...
use crate::backend::state::{Eval, Status, TimeInfo, Worker, WorkerStatus, WorkerUpdate};
...
pub trait StateAccess: Send {
    ...
    async fn add_worker(
        ...
        work_dir: &str,
        location: &str,
        capability_profile: Option<crate::backend::CapabilityProfile>,
    ...
    async fn create_worker_concern(
        ...
        status: &str,
        source: Option<&str>,
    ) -> StateAccessResult<crate::backend::WorkerConcern>;
    ...
    async fn get_history(
        &self,
        limit: i64,
    ) -> StateAccessResult<Vec<crate::backend::state::HistoryEntry>>;
    ...
    async fn claim_node(
        ...
        id: &str,
        worker_name: &str,
    ) -> StateAccessResult<crate::backend::delta::BoardNode>;
    ...
    async fn get_claimed_node(
        &self,
        worker_name: &str,
    ) -> StateAccessResult<Option<crate::backend::delta::BoardNode>>;

    /// Get claimable nodes
    async fn get_claimable_nodes(&self)
        -> StateAccessResult<Vec<crate::backend::delta::BoardNode>>;

    /// Get all nodes
    async fn get_nodes(&self) -> StateAccessResult<Vec<crate::backend::delta::BoardNode>>;
...
impl From<crate::backend::state::StateError> for StateAccessError {
...
impl StateAccess for SQLiteState {
    ...
    async fn add_node(
        ...
        use crate::backend::delta::{DeltaState, NodeKind};
