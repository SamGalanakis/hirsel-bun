...
impl From<crate::backend::state::StateError> for OrchestratorError {
    fn from(e: crate::backend::state::StateError) -> Self {
        OrchestratorError::State(e.to_string())
    }
}

impl From<crate::backend::project::ProjectError> for OrchestratorError {
    fn from(e: crate::backend::project::ProjectError) -> Self {
        OrchestratorError::Other(e.to_string())
    }
}

impl From<crate::backend::shepherd_chat::ShepherdChatError> for OrchestratorError {
    fn from(e: crate::backend::shepherd_chat::ShepherdChatError) -> Self {
        OrchestratorError::Other(e.to_string())
    }
}

impl From<crate::backend::delta::DeltaStateError> for OrchestratorError {
...
pub struct ResumeWorkerRequest {
    ...
    pub state_handle: Option<crate::backend::snapshot::WorkerStateHandle>,
}
