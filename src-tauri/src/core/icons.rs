//! Lucide icon SVG helper for Maud templates.

use maud::{Markup, PreEscaped};

/// Render a Lucide icon as inline SVG (16x16 default).
pub fn icon(name: &str) -> Markup {
    icon_sized(name, 16)
}

/// Render a Lucide icon at a specific size.
pub fn icon_sized(name: &str, size: u32) -> Markup {
    let paths = match name {
        ...
        "copy-plus" => {
            r#"<line x1="15" x2="15" y1="12" y2="18"/><line x1="12" x2="18" y1="15" y2="15"/><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>"#
        }
        "cpu" => {
        ...
        "package" => {
            r#"<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"/>"#
        }
        "pencil" => {
        ...
        "save" => {
            r#"<path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7H7v7"/><path d="M7 3v4h7"/>"#
        }
        "send" => {
        ...
        _ => return PreEscaped(String::new()).into(),
    };
    PreEscaped(format!(
        r#"<svg xmlns="http://www.w3.org/2000/svg" width="{s}" height="{s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">{p}</svg>"#,
        s = size,
        p = paths
    ))
    .into()
